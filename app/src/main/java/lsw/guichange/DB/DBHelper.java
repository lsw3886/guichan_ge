...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String bookMark = "CREATE TABLE Bookmark(sitename VARCHAR(20), link VARCHAR(100), comment VARCHAR(3), postnum VARCHAR(10), title VARCHAR(10), date INTEGER, bimg INTEGER, btitle VARCHAR(5));";
